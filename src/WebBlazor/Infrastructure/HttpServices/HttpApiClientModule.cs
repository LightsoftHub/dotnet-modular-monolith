...
public record HttpApiClientModule;

public static class Startup
{
    public static IServiceCollection AddHttpApiClients(this IServiceCollection services, IConfiguration configuration)
    {
    ...
    public static IServiceCollection AddHttpApiServices(
